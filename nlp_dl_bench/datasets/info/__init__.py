...
def get_label_map(dataset: str) -> Tuple[Dict[str, int], Dict[int, str]]:
    ...
    elif dataset == 'yelp_polarity' or dataset == 'yelp_review_polarity':
        classes = yelp_polarity.classes
    elif dataset == 'yelp_full' or dataset == 'yelp_review_full':
        classes = yelp_full.classes
    elif dataset == 'yahoo_answers':
        classes = yahoo_answers.classes
    elif dataset == 'amazon_polarity' or dataset == 'amazon_review_polarity':
        classes = amazon_polarity.classes
    elif dataset == 'amazon_full' or dataset == 'amazon_review_full':
